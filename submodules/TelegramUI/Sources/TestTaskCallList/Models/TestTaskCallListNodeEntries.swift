...
enum TestTaskCallListNodeEntryId: Hashable {
    case setting(Int32)
...
enum TestTaskCallListNodeEntry: Comparable, Identifiable {
    ...
    var stableId: TestTaskCallListNodeEntryId {
        switch self {
        case .displayTab:
            return .setting(0)
        case .displayTabInfo:
    ...
    static func <(lhs: TestTaskCallListNodeEntry, rhs: TestTaskCallListNodeEntry) -> Bool {
...
func callListNodeEntriesForView(view: EngineCallList, groupCalls: [EnginePeer], state: CallListNodeState, showSettings: Bool, showCallsTab: Bool, isRecentCalls: Bool, currentGroupCallPeerId: EnginePeer.Id?) -> [TestTaskCallListNodeEntry] {
    var result: [TestTaskCallListNodeEntry] = []
...
func countMeaningfulCallListEntries(_ entries: [TestTaskCallListNodeEntry]) -> Int {
    var count: Int = 0
